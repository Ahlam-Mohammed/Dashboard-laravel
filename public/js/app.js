...
// node_modules/@vue/shared/index.blade.php.js
...
// node_modules/@vue/reactivity/index.blade.php.js
...
// packages/alpinejs/src/index.blade.php.js
...
;(function() {
  ...
  /**
   * Used by `_.trim` and `_.trimEnd` to get the index.blade.php of the last non-whitespace
   * character of `string`.
   *
   * @private
   * @param {string} string The string to inspect.
   * @returns {number} Returns the index.blade.php of the last non-whitespace character.
   */
